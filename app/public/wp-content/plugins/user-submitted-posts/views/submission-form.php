...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" action="">
		...
		<fieldset class="usp-title">
			<label for="user-submitted-title">タイトル</label>
			<input id="user-submitted-title" name="user-submitted-title" type="text" value="" placeholder="タイトル">
		</fieldset>
		...
		<fieldset class="usp-tags">
			<label for="user-submitted-tags">#タグ</label>
			<input id="user-submitted-tags" name="user-submitted-tags" type="text" value="" placeholder="LIXIL,INAX"<?php if (usp_check_required('usp_tags')) echo $usp_required; ?> class="usp-input">
		</fieldset>
		<?php } ?>
		...
		<fieldset class="usp-images">
			<label for="user-submitted-image">サムネイル</label>
		...
		<div id="usp-submit">
			...
			<input type="submit" class="usp-submit" id="user-submitted-post" name="user-submitted-post" value="送信する">
